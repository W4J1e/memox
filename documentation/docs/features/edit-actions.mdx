...
memoX allows you to customize which actions are immediately available in the edit screen's toolbar and bottom bar. This helps you keep your most-used tools just a tap away.
...
- 🔗 **Note Link**: Create a link to another note within memoX
