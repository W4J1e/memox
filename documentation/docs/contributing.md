...
memoX is an open-source project, and contributions from the community are welcome and appreciated. This guide explains how you can contribute to the project, whether you're a developer, translator, or user.

## Ways to Contribute

There are many ways to contribute to memoX, regardless of your technical skills:

### For Everyone

- **Report bugs**: If you find a bug, report it on [GitHub Issues](https://github.com/Crustack/memoX/issues/new/choose)
- **Suggest features**: Have an idea for a new feature? Share it on [GitHub Issues](https://github.com/Crustack/memoX/issues/new/choose)
- **Improve documentation**: Help improve this documentation by suggesting changes or additions
- **Spread the word**: Share memoX with others who might find it useful
- **Translate the app**: Help make memoX available in more languages, see `Contributing Translations` below
...
If you want to contribute code to memoX, follow these steps:

### Setting Up the Development Environment

1. **Fork the repository**: Go to [memoX on GitHub](https://github.com/Crustack/memoX) and click the "Fork" button
2. **Clone your fork**: 
   ```bash
   git clone https://github.com/YOUR_USERNAME/memoX.git
   ```
...
1. Download the current [translations.xlsx](https://github.com/Crustack/memoX/raw/refs/heads/main/app/translations.xlsx) file
...
3. Open an [Update Translations Issue](https://github.com/Crustack/memoX/issues/new?assignees=&labels=translations&projects=&template=translation.md&title=%3CINSERT+LANGUAGE+HERE%3E+translations+update)
