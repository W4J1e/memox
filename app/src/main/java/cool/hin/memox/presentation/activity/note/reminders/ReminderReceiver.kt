package cool.hin.memox.presentation.activity.note.reminders
...
import cool.hin.memox.data.model.findLastNotified
import cool.hin.memox.data.model.lastNotification
...
import cool.hin.memox.utils.canScheduleAlarms
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    private fun getDatabase(context: Context): MemoXDatabase {
        return MemoXDatabase.getDatabase(context.applicationContext as Application, false).value
    }
    ...
    companion object {
        ...
        private const val GROUP_REMINDERS = "memox.notifications.group.2.reminders"
        private const val NOTIFICATION_TAG = "memox.notifications.note-reminders"

        const val EXTRA_REMINDER_ID = "memox.intent.extra.REMINDER_ID"
        const val EXTRA_NOTE_ID = "memox.intent.extra.NOTE_ID"
        const val ACTION_NOTIFICATION_DISMISSED =
            "cool.hin.memox.ACTION_NOTIFICATION_DISMISSED"
        const val ACTION_UNPIN_NOTE = "cool.hin.memox.ACTION_UNPIN_NOTE"
        const val ACTION_PINNED_NOTIFICATION_DISMISSED =
            "cool.hin.memox.ACTION_STATUS_NOTIFICATION_DISMISSED"
        const val ACTION_DELETE_NOTE = "cool.hin.memox.ACTION_DELETE_NOTE"
        const val ACTION_UPDATE_NOTIFICATIONS = "cool.hin.memox.ACTION_UPDATE_NOTIFICATIONS"
