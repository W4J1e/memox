...
import cool.hin.memox.presentation.view.main.label.LabelAdapter
import cool.hin.memox.presentation.view.main.label.LabelData
import cool.hin.memox.presentation.view.main.label.LabelListener
...
class LabelsFragment : Fragment(), LabelListener {
    ...
    override fun onToggleVisibility(position: Int) {
        labelAdapter?.currentList?.get(position)?.let { value ->
            ...
            SyncRouter.syncNow(requireActivity().applicationContext)
