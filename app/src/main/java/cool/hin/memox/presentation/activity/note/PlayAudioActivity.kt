...
import cool.hin.memox.databinding.ActivityPlayAudioBinding
...
import cool.hin.memox.utils.audio.AudioPlayService
import cool.hin.memox.utils.audio.LocalBinder
...
class PlayAudioActivity : LockedActivity<ActivityPlayAudioBinding>() {
    ...
    companion object {
        const val EXTRA_AUDIO = "memox.intent.extra.AUDIO"
    }
}
