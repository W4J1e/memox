...
import cool.hin.memox.presentation.view.note.listitem.adapter.ListItemHighlight
...
import cool.hin.memox.presentation.view.note.listitem.setItems
import cool.hin.memox.presentation.view.note.listitem.sorting.SortedItemsList
import cool.hin.memox.presentation.view.note.listitem.splitByChecked
import cool.hin.memox.presentation.view.note.listitem.toMutableList
...
import cool.hin.memox.presentation.viewmodel.preference.callback
import cool.hin.memox.utils.findAllOccurrences
import cool.hin.memox.utils.indices
import cool.hin.memox.utils.mapIndexed
...
class EditListActivity : EditActivity(Type.LIST) {
    ...
    override fun openMoreOptionsBottomSheet() {
        val prefs = MemoXPreferences.getInstance(this@EditListActivity)
    ...
    override fun setStateFromModel(savedInstanceState: Bundle?) {
        ...
        adapter =
            ListItemAdapter(
                ...
                elevation,
                MemoXPreferences.getInstance(application),
                listManager,
                false,
                binding.ScrollView,
            )
    ...
    companion object {
        private const val EXTRA_ITEM_POS = "memox.intent.extra.ITEM_POS"
