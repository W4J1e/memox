...
import cool.hin.memox.databinding.ActivityViewImageBinding
...
import cool.hin.memox.presentation.view.note.image.ImageAdapter
...
class ViewImageActivity : LockedActivity<ActivityViewImageBinding>() {
            ...
            val intent =
                Intent(Intent.ACTION_CREATE_DOCUMENT)
                    .apply {
                        ...
                        putExtra(Intent.EXTRA_TITLE, "memoX Image")
                    }
    ...
    companion object {
        const val EXTRA_POSITION = "memox.intent.extra.POSITION"
        const val CURRENT_IMAGE = "CURRENT_IMAGE"
        const val EXTRA_DELETED_IMAGES = "memox.intent.extra.DELETED_IMAGES"
    }
}
