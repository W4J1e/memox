...
import cool.hin.memox.presentation.activity.note.PickNoteActivity.Companion.EXTRA_EXCLUDE_NOTE_ID
import cool.hin.memox.presentation.activity.note.PickNoteActivity.Companion.EXTRA_PICKED_NOTE_ID
import cool.hin.memox.presentation.activity.note.PickNoteActivity.Companion.EXTRA_PICKED_NOTE_TITLE
import cool.hin.memox.presentation.activity.note.PickNoteActivity.Companion.EXTRA_PICKED_NOTE_TYPE
import cool.hin.memox.presentation.activity.note.SelectLabelsActivity.Companion.EXTRA_SELECTED_LABELS
...
import cool.hin.memox.presentation.view.note.action.ExportBottomSheet
...
import cool.hin.memox.utils.backup.exportNote
...
class NoteActionHandler(
    ...
    private val notallyModel: MemoXModel,
) {
