...
import cool.hin.memox.data.model.isImage
...
import cool.hin.memox.presentation.viewmodel.progress.DeleteAttachmentProgress
...
private fun ContextWrapper.isDataInPublicEnabled(): Boolean {
    return MemoXPreferences.getInstance(this).dataInPublicFolder.value
}
...
const val APP_LOG_FILE_NAME = "memox-logs"
