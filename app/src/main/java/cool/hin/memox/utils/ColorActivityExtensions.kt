...
import cool.hin.memox.databinding.DialogColorBinding
import cool.hin.memox.databinding.DialogColorPickerBinding
import cool.hin.memox.presentation.createTextView
...
import cool.hin.memox.presentation.view.main.ColorAdapter
...
private fun AppCompatActivity.showEditColorDialog(
    ...
    val preferences = MemoXPreferences.getInstance(this@showEditColorDialog)
    dialog =
