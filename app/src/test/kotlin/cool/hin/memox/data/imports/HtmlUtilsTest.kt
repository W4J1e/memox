...
class HtmlUtilsTest {
    ...
    fun `parseBodyAndSpansFromHtml Evernote`() {
        val contentHtml =
            ...
            <en-note>
              ...
              <div>
                <a href="https://github.com/Crustack/memoX">https://github.com/Crustack/memoX</a>
              </div>
              <div>
                <br />
              </div>
        ...
        assertThat(spans)
            ...
            .anyMatch {
                body.substringOfSpan(it) == "https://github.com/Crustack/memoX" &&
                    it.link &&
                    it.linkData.equals("https://github.com/Crustack/memoX")
            }
    }
    ...
    fun `parseBodyAndSpansFromHtml Google Keep`() {
        val contentHtml =
            ...
            https://github.com/Crustack/memoX</span>
            </p>
            <br/>
            <br/>
            <br/>
