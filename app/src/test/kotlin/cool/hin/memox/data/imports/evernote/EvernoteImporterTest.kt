package cool.hin.memox.data.imports.google

import cool.hin.memox.data.imports.evernote.EvernoteImporter
import cool.hin.memox.data.imports.evernote.EvernoteNote
import cool.hin.memox.data.imports.evernote.EvernoteResource
import cool.hin.memox.data.imports.evernote.EvernoteResourceAttributes
import cool.hin.memox.data.imports.evernote.EvernoteResourceData
import cool.hin.memox.data.imports.evernote.EvernoteTag
import cool.hin.memox.data.imports.evernote.EvernoteTask
import cool.hin.memox.data.imports.evernote.TaskStatus
import cool.hin.memox.data.imports.evernote.mapToBaseNote
                ...
                Condition(
                    {
                        it.title == "Text formatting" &&
                            it.content.containsAll(
                                ...
                                "https://github.com/Crustack/memoX",
                            )
                    },
                    "Text formatting",
                ),
